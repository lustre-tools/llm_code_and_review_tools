...
class TestReviewParserPostAttributes:
    ...
    def test_review_parser_post_comment_options(self):
        """All --post-comments related flags parse and land on the namespace."""
        ...
        args = parser.parse_args([
            'review', 'https://example.com/12345',
            '--post-comments', 'review.json',
            '--prefix', '[Marc Bot]',
        ...
        assert args.post_comments == 'review.json'
        assert args.prefix == '[Marc Bot]'
        assert args.tag == 'autogenerated:ai-review'
        assert args.message == 'Overall'
        assert args.vote == 1
        assert args.dry_run is True

    def test_review_parser_post_defaults(self):
        """Flags cmd_review reads via getattr default to None/False."""
        from gerrit_cli.parsers import add_review_parser
