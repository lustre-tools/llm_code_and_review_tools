...
def render_unknown_failure_control(
    ...
    *,
    ...
    reasons = []
    if mode == "disabled":
        # Say how to enable it, not just that it is off. The per-feature
        # research policy form is not rendered anywhere: the standing policy
        # is the control, and Tests=Investigate is what turns this on.
        reasons.append(
            "Unknown-failure investigation is disabled for this patch. "
            "Set the standing policy Tests to Investigate to enable it."
        )
