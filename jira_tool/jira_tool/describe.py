...
def get_tool_description() -> ToolDescription:
    ...
    return ToolDescription(
        ...
        commands=[
            ...
            Command(
                name="set-component",
                description="Add components to an issue (additive; use --replace to replace all)",
                usage="jira set-component <KEY> <COMPONENT> [<COMPONENT> ...] [--replace]",
                arguments=[
                    Argument(name="key", description="Issue key or JIRA URL", required=True),
                    Argument(name="components", description="Component names to add", required=True),
                    Argument(name="--replace", description="Replace all existing components instead of adding", type="boolean", default=False),
                ],
                examples=["jira set-component LU-19900 lov", "jira set-component LU-19900 lov osc --replace"],
                output_fields=["issue_key", "components", "mode"],
                next_actions=["get", "remove-component"],
            ),
            Command(
                name="remove-component",
                description="Remove components from an issue",
                usage="jira remove-component <KEY> <COMPONENT> [<COMPONENT> ...]",
                arguments=[
                    Argument(name="key", description="Issue key or JIRA URL", required=True),
                    Argument(name="components", description="Component names to remove", required=True),
                ],
                examples=["jira remove-component LU-19900 lov"],
                output_fields=["issue_key", "components_removed"],
                next_actions=["get"],
            ),
            Command(
                name="versions",
            ...
            Command(
                ...
                description="Add fix versions to an issue (additive; use --replace to replace all)",
                usage="jira set-fix-version <KEY> <VERSION> [<VERSION> ...] [--replace]",
                arguments=[
                    Argument(name="key", description="Issue key or JIRA URL", required=True),
                    Argument(name="versions", description="Version names to add", required=True),
                    Argument(name="--replace", description="Replace all existing fix versions instead of adding", type="boolean", default=False),
                ],
                examples=["jira set-fix-version LU-19900 2.16.0", "jira set-fix-version LU-19900 2.16.0 --replace"],
                output_fields=["issue_key", "fix_versions", "mode"],
                next_actions=["get", "remove-fix-version"],
            ),
            Command(
                name="remove-fix-version",
                description="Remove fix versions from an issue",
                usage="jira remove-fix-version <KEY> <VERSION> [<VERSION> ...]",
                arguments=[
                    Argument(name="key", description="Issue key or JIRA URL", required=True),
                    Argument(name="versions", description="Version names to remove", required=True),
                ],
                examples=["jira remove-fix-version LU-19900 2.16.0"],
                output_fields=["issue_key", "fix_versions_removed"],
                next_actions=["get"],
            ),
            Command(
                name="create-subtask",
            ...
            Command(
                ...
                next_actions=["transition (with a transition name or ID from results)"],
            ),
            Command(
                name="transition",
